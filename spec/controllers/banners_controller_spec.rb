  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved banner as @banner" do
        ...
        post :create, {:banner => { "imagen" => "invalid value" }}, valid_session
        assigns(:banner).should be_a_new(Banner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested banner" do
        ...
        Banner.any_instance.should_receive(:update_attributes).with({ "imagen" => "MyString" })
        put :update, {:id => banner.to_param, :banner => { "imagen" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the banner as @banner" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Banner.any_instance.stub(:save).and_return(false)
        put :update, {:id => banner.to_param, :banner => { "imagen" => "invalid value" }}, valid_session
        assigns(:banner).should eq(banner)
      end
